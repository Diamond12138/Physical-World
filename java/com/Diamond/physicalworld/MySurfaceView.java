...
public class MySurfaceView extends GLSurfaceView {
    public class MyRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 p1, EGLConfig p2) {
            ...
            lightingProgram = new Program("shader/shadow.vert", "shader/lighting.frag", null, getResources());
            ...
            ground.setPositionY(0.99f).setScale(new Float3(WORLD_SIZE, 0, WORLD_SIZE));
        ...
        public void onDrawFrame(GL10 p1) {
            try {
                ...
                lightingProgram.setUniform("u_lightdirection", new Float3(100, -25, 50));
                ...
                lightingProgram.setUniform("u_enableShadow", false);
                ...
                for (int i = 0; i < rigidSprites.size(); i++) {
                    ...
                    lightingProgram.setUniform("u_enableShadow", false);
                    rs.draw(lightingProgram);
                    lightingProgram.setUniform("u_enableShadow", true);
                    rs.draw(lightingProgram);
                }
            } catch (Exception e) {
                e.printStackTrace();
