...
public class MainActivity extends Activity {
    ...
    public TextView rigidNumberTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (object_index == 0) {
                    	...
                    	AddUtil.addCylinder(surfaceView, 1);
                    }

                    updateRigidNumberTextView();
                }
            });
        ...
        launchButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (object_index == 0) {
                        ...
                        AddUtil.launchCylinder(surfaceView, 1, v);
                    }
        ...
        launchButton.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    if (object_index == 0) {
                        ...
                        AddUtil.launchCylinder(surfaceView, 5, v);
                    }
        ...
        positionTextView.setText("位置：\nx:0\ny:5\nz:-10)");
        positionTextView.setBackgroundColor(Color.WHITE);
        positionTextView.setLayoutParams(new ViewGroup.LayoutParams(200, 300));
        RelativeLayout.LayoutParams positionp = new RelativeLayout.LayoutParams(positionTextView.getLayoutParams());
        positionp.setMargins(0, 200, 300, 500);
        positionTextView.setLayoutParams(positionp);
        positionTextView.setClickable(true);
        relativeLayout1.addView(positionTextView);

        rigidNumberTextView = new TextView(this);
        rigidNumberTextView.setText("刚体数：\n1000");
        rigidNumberTextView.setBackgroundColor(Color.WHITE);
        rigidNumberTextView.setLayoutParams(new ViewGroup.LayoutParams(200, 100));
        RelativeLayout.LayoutParams rigidNumberp = new RelativeLayout.LayoutParams(rigidNumberTextView.getLayoutParams());
        rigidNumberp.setMargins(0, 500, 200, 600);
        rigidNumberTextView.setLayoutParams(rigidNumberp);
        rigidNumberTextView.setClickable(true);
        relativeLayout1.addView(rigidNumberTextView);
    ...
    public void updateRigidNumberTextView() {
        rigidNumberTextView.setText("刚体数：\n" + surfaceView.renderer.rigidSprites.size());
    }
} 
